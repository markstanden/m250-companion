package C7_Arrays.Quiz1.CustomerService;
...
public class CustomerService {
    ...
    public void printNamesInvoicesMoreThan(double amount) {
        long ordersAboveAmount = Arrays.stream(orders)// --> Stream<C7_Arrays.Quiz1.CustomerService.Order>
                .filter(order -> order.getInvoiceAmount() > amount) // --> Stream<C7_Arrays.Quiz1.CustomerService.Order>
